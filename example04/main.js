const crossfilter = require("@mapd/mapd-crossfilter/dist/mapd-crossfilter");

import "babel-polyfill";
import * as dc from "@mapd/mapd-charting/dist/mapdc"
...
function init() {
  ...
  establishConnection()
    .then(con => {
       ...
       */
      crossfilter.crossfilter(con, table).then(createCharts);
      /*
